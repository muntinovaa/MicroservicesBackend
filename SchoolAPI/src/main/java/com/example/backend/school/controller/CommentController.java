...
import com.example.backend.school.repository.CommentRepository;
import com.example.backend.school.repository.TutorialDetailsRepository;
...
public class CommentController {
    @Autowired
    private TutorialDetailsRepository tutorialRepository;
